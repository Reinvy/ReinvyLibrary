...
| [Database Integration with MongoDB and Mongoose in Express JS](backend/expressjs/tutorials/database-integration-with-mongo-db-and-mongoose.md) | Tutorial | Beginner | [EN](backend/expressjs/tutorials/database-integration-with-mongo-db-and-mongoose.md) \| [ID](backend/expressjs/tutorials/database-integration-with-mongo-db-and-mongoose_id.md) |
...
| [Langkah Integrasi Prisma dengan Express.js](backend/expressjs/tutorials/express-with-prisma_id.md) | Tutorial | Intermediate | [ID](backend/expressjs/tutorials/express-with-prisma_id.md) |
...
| [Menangani Background Jobs dan Task Queues di Express JS](backend/expressjs/tutorials/handling-background-jobs-and-task-queues.md) | Tutorial | Advanced | [EN](backend/expressjs/tutorials/handling-background-jobs-and-task-queues.md) \| [ID](backend/expressjs/tutorials/handling-background-jobs-and-task-queues_id.md) |
| [Handling Background Jobs in Express JS with BullMQ and Redis](backend/expressjs/tutorials/handling-background-jobs-in-express-js-with-bull-mq-and-redis.md) | Tutorial | Advanced | [EN](backend/expressjs/tutorials/handling-background-jobs-in-express-js-with-bull-mq-and-redis.md) \| [ID](backend/expressjs/tutorials/handling-background-jobs-in-express-js-with-bull-mq-and-redis_id.md) |
...
| [Menerapkan Health Checks di Express JS](backend/expressjs/tutorials/implementing-health-checks.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/implementing-health-checks.md) \| [ID](backend/expressjs/tutorials/implementing-health-checks_id.md) |
...
| [Implementasi OAuth 2.0 dan Social Login di Express JS](backend/expressjs/tutorials/implementing-oauth-2-0-and-social-login.md) | Tutorial | Advanced | [EN](backend/expressjs/tutorials/implementing-oauth-2-0-and-social-login.md) \| [ID](backend/expressjs/tutorials/implementing-oauth-2-0-and-social-login_id.md) |
| [Implementing OAuth 2.0 Authentication in Express JS](backend/expressjs/tutorials/implementing-oauth-2-0-authentication.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/implementing-oauth-2-0-authentication.md) \| [ID](backend/expressjs/tutorials/implementing-oauth-2-0-authentication_id.md) |
| [Implementing OAuth 2.0 Authentication in Express JS with Passport](backend/expressjs/tutorials/implementing-oauth-2-0-authentication-in-express-js-with-passport.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/implementing-oauth-2-0-authentication-in-express-js-with-passport.md) \| [ID](backend/expressjs/tutorials/implementing-oauth-2-0-authentication-in-express-js-with-passport_id.md) |
| [Implementing OAuth 2.0 Social Login in Express JS](backend/expressjs/tutorials/implementing-oauth-2-0-social-login.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/implementing-oauth-2-0-social-login.md) \| [ID](backend/expressjs/tutorials/implementing-oauth-2-0-social-login_id.md) |
| [Menerapkan OAuth2 dan Social Login di Express.js](backend/expressjs/tutorials/implementing-oauth2-and-social-login.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/implementing-oauth2-and-social-login.md) \| [ID](backend/expressjs/tutorials/implementing-oauth2-and-social-login_id.md) |
| [Implementing OAuth2 Authentication in Express JS](backend/expressjs/tutorials/implementing-oauth2-authentication.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/implementing-oauth2-authentication.md) \| [ID](backend/expressjs/tutorials/implementing-oauth2-authentication_id.md) |
| [Implementing OAuth2 Authentication in Express JS with Passport](backend/expressjs/tutorials/implementing-oauth2-authentication-in-express-js-with-passport.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/implementing-oauth2-authentication-in-express-js-with-passport.md) \| [ID](backend/expressjs/tutorials/implementing-oauth2-authentication-in-express-js-with-passport_id.md) |
| [Mengimplementasikan Autentikasi OAuth2 dengan Passport di Express JS](backend/expressjs/tutorials/implementing-oauth2-authentication-with-passport.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/implementing-oauth2-authentication-with-passport.md) \| [ID](backend/expressjs/tutorials/implementing-oauth2-authentication-with-passport_id.md) |
| [Implementasi Login Google OAuth2 di Express JS](backend/expressjs/tutorials/implementing-oauth2-google-login.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/implementing-oauth2-google-login.md) \| [ID](backend/expressjs/tutorials/implementing-oauth2-google-login_id.md) |
| [Mengimplementasikan OAuth2 Social Login di Express JS dengan Passport](backend/expressjs/tutorials/implementing-oauth2-social-login-in-express-js-with-passport.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/implementing-oauth2-social-login-in-express-js-with-passport.md) \| [ID](backend/expressjs/tutorials/implementing-oauth2-social-login-in-express-js-with-passport_id.md) |
...
| [Implementasi Server-Sent Events (SSE) di Express JS](backend/expressjs/tutorials/implementing-server-sent-events.md) | Tutorial | Beginner | [EN](backend/expressjs/tutorials/implementing-server-sent-events.md) \| [ID](backend/expressjs/tutorials/implementing-server-sent-events_id.md) |
...
| [Langkah Membuat Project Express.js dengan Express Generator](backend/expressjs/tutorials/install_id.md) | Tutorial | Intermediate | [ID](backend/expressjs/tutorials/install_id.md) |
...
| [Mengintegrasikan TypeScript dengan Express JS](backend/expressjs/tutorials/integrating-type-script.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/integrating-type-script.md) \| [ID](backend/expressjs/tutorials/integrating-type-script_id.md) |
...
| [Performance Optimization in Express JS](backend/expressjs/tutorials/performance-optimization.md) | Tutorial | Advanced | [EN](backend/expressjs/tutorials/performance-optimization.md) \| [ID](backend/expressjs/tutorials/performance-optimization_id.md) |
...
| [Validasi Skema di Express JS dengan Zod](backend/expressjs/tutorials/schema-validation-in-express-js-with-zod.md) | Tutorial | Advanced | [EN](backend/expressjs/tutorials/schema-validation-in-express-js-with-zod.md) \| [ID](backend/expressjs/tutorials/schema-validation-in-express-js-with-zod_id.md) |
...
| [Streaming and Downloading Files in Express JS](backend/expressjs/tutorials/streaming-and-downloading-files.md) | Tutorial | Intermediate | [EN](backend/expressjs/tutorials/streaming-and-downloading-files.md) \| [ID](backend/expressjs/tutorials/streaming-and-downloading-files_id.md) |
...
| [Bekerja dengan Cookie dan Session di Express JS](backend/expressjs/tutorials/working-with-cookies-and-sessions.md) | Tutorial | Beginner | [EN](backend/expressjs/tutorials/working-with-cookies-and-sessions.md) \| [ID](backend/expressjs/tutorials/working-with-cookies-and-sessions_id.md) |
