...
- **Technologies**: `expressjs`, `elysiajs`, `nextjs`, `react-native`, `flutter`, `golang`, `laravel`, `docker`, `pm2`, `redis`, `mongodb`, `postgres`, `swift`, `kotlin`, `kubernetes`, `nestjs`, `vuejs`, `github-actions`, `tailwindcss`, `svelte`
