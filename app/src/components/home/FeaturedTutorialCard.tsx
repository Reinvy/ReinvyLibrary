...
export default function FeaturedTutorialCard({
  ...
  return (
    <PaperCard
      as="article"
      rotate
      className="col-span-2 row-span-2 flex h-full flex-col p-6"
    >
      <WashiTape />
      ...
      <div className="mt-auto pt-4">
        <Link
          href={href}
          className="inline-flex items-center gap-1.5 rounded-full bg-sticky px-4 py-2 font-hand text-sm text-ink shadow-paper transition hover:rotate-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-terracotta/60"
        >
          {readMore}
